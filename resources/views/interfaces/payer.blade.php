...
<section class="details_prds">
    <div class="details_bg">
        ...
        @else
        <img id="bg_change" src="{{asset('images/no-data.png')}}" alt="">
        @endif
    </div>
    ...
    <div class="details_txt">
        ...
        <div class="conseil">
            ...
            <p>
                Avant d'éffectuer l'achat vous devez vous s'inscrire sur notre plateforme (ou vous connecter si vous
                êtes deja inscris) en cliquant sur le boutton si dessous.
            </p>
        </div>
        <div
            style="display: flex;justify-content: space-between;align-items: center;width: 200px;height: 60px;margin:auto;">
            <a href="{{route('payer.form',$produit->id)}}"
                style="padding: 0;display: flex;justify-content: center;align-items: center;border-radius: 22px;width: calc(100% - 10px);height: 100%;margin: 0 10px">
                <img style="width: 100%;height: 100%;border-radius: 12px;"
                    src="{{asset('images/visa_master_card.jpeg')}}" alt="">
            </a>
            <a href="#"
                style="padding: 0;display: flex;justify-content: center;align-items: center;border-radius: 22px;width: calc(100% - 10px);height: 100%;margin: 0 10px">
